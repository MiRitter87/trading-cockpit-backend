...
/**
 * Provides localized validation messages for several annotations of the Bean Validation framework.<p>
 * 
 * In order to make this concept work, the property file "ValidationMessages.properties" has to store properties in a defined form:<br>
 ...
 * -Lastly comes the word message<p>
 * 
...
public class ValidationMessageProvider {
	 ...
	 */
	public String getSizeValidationMessage(final String className, final String attributeName, 
			final String actualValue, final String minValue, final String maxValue) {
