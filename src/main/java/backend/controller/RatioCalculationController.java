...
public class RatioCalculationController {
	 ...
	 */
	public List<Quotation> getRatios(final Instrument dividendInstrument, final Instrument divisorInstrument) throws Exception {
	 ...
	 */
	private void checkQuotationsExistForRatio(final Instrument dividendInstrument, final Instrument divisorInstrument) throws Exception {
