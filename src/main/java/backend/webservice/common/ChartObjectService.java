...
/**
 * Common implementation of the chart object WebService that can be used by multiple service interfaces like SOAP or
 * REST. This service provides functions to manage objects like lines that can be drawn onto charts.
 *
 * @author Michael
 */
public class ChartObjectService {
    ...
    public WebServiceResult getHorizontalLine(final Integer id) {
        ...
        try {
            ...
            LOGGER.error(MessageFormat.format(this.resources.getString("horizontalLine.getHorizontalLineError"), id),
                    e);
        }
    ...
    public WebServiceResult getHorizontalLines(final Integer instrumentId) {
        ...
        try {
            ...
            getHorizontalLinesResult.addMessage(new WebServiceMessage(WebServiceMessageType.E,
                    this.resources.getString("horizontalLine.getHorizontalLinesError")));
    ...
    public WebServiceResult addHorizontalLine(final HorizontalLineWS horizontalLine) {
        ...
        try {
            ...
            addHorizontalLineResult.addMessage(new WebServiceMessage(WebServiceMessageType.E,
                    this.resources.getString("horizontalLine.addError")));
        ...
        try {
            ...
            addHorizontalLineResult.addMessage(new WebServiceMessage(WebServiceMessageType.S,
                    this.resources.getString("horizontalLine.addSuccess")));
    ...
    public WebServiceResult updateHorizontalLine(final HorizontalLineWS horizontalLine) {
        ...
        try {
            ...
            updateHorizontalLineResult.addMessage(new WebServiceMessage(WebServiceMessageType.E,
                    this.resources.getString("horizontalLine.updateError")));
        ...
        try {
            ...
            updateHorizontalLineResult.addMessage(new WebServiceMessage(WebServiceMessageType.S, MessageFormat.format(
                    this.resources.getString("horizontalLine.updateSuccess"), convertedHorizontalLine.getId())));
        } catch (ObjectUnchangedException objectUnchangedException) {
            updateHorizontalLineResult.addMessage(new WebServiceMessage(WebServiceMessageType.I, MessageFormat.format(
                    this.resources.getString("horizontalLine.updateUnchanged"), convertedHorizontalLine.getId())));
        } catch (Exception e) {
            updateHorizontalLineResult.addMessage(new WebServiceMessage(WebServiceMessageType.E, MessageFormat
                    .format(this.resources.getString("horizontalLine.updateError"), convertedHorizontalLine.getId())));

            LOGGER.error(MessageFormat.format(this.resources.getString("horizontalLine.updateError"),
                    convertedHorizontalLine.getId()), e);
        }
    ...
    /**
     * Converts the lean HorizontalLine representation that is provided by the WebService to the internal data model for
     * further processing.
     *
     ...
     */
    private void validateHorizontalLine(final HorizontalLine horizontalLine, final WebServiceResult webServiceResult) {
        try {
