...
public class ScanService {
    ...
    public WebServiceResult getScans() {
        ...
        try {
            ...
            getScansResult.addMessage(
                    new WebServiceMessage(WebServiceMessageType.E, this.resources.getString("scan.getScansError")));
    ...
    public WebServiceResult updateScan(final ScanWS scan) {
        ...
        try {
            ...
            updateScanResult.addMessage(
                    new WebServiceMessage(WebServiceMessageType.E, this.resources.getString("scan.updateError")));
    ...
    public WebServiceResult addScan(final ScanWS scan) {
        ...
        try {
            ...
            addScanResult.addMessage(
                    new WebServiceMessage(WebServiceMessageType.E, this.resources.getString("scan.addError")));
        ...
        try {
            ...
            addScanResult.addMessage(
                    new WebServiceMessage(WebServiceMessageType.S, this.resources.getString("scan.addSuccess")));
    ...
    /**
     * Converts the lean Scan representation that is provided by the WebService to the internal data model for further
     * processing.
     *
    ...
    private WebServiceResult update(final Scan scan) {
        ...
        try {
            ...
            updateScanResult.addMessage(new WebServiceMessage(WebServiceMessageType.I, MessageFormat.format(
                    this.resources.getString("scan.updateScansInProgressExist"), scanInProgressException.getScanId())));
        } catch (Exception e) {
