...
public interface ScanDAO {
	 ...
	 */
	void insertScan(final Scan scan) throws Exception;
	 ...
	 */
	void deleteScan(final Scan scan) throws Exception;
	 ...
	 */
	Scan getScan(final Integer id) throws Exception;
	 ...
	 */
	void updateScan(final Scan scan) throws ObjectUnchangedException, Exception;
}
