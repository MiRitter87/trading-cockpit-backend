...
public class TemplateBuyableBaseProcessor {
     ...
     * checks for each Instrument of the given quotations if the price is at least 10% above the EMA(21). Extended
     * quotations are removed from the List of quotations.
     *
    ...
    /**
     * Checks if the given quotation is extended by at least 10% above the EMA(21).
     *
    ...
    private boolean isExtendedAboveEma21(final Quotation quotation) {
        final float extendedFactor = (float) 1.1;
