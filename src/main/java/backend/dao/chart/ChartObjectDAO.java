...
/**
 * Interface for chart object persistence.
 * A chart object can be a HorizontalLine.
 * 
 * @author Michael
 */
public interface ChartObjectDAO {
	 ...
	 */
	void insertHorizontalLine(final HorizontalLine horizontalLine) throws Exception;
	 ...
	 */
	void deleteHorizontalLine(final HorizontalLine horizontalLine) throws Exception;
	
	
	/**
	 * Gets all horizontal lines of the Instrument with the given ID.
	 * If not Instrument ID is provided, all horizontal lines are retrieved.
	 * 
	 ...
	 */
	List<HorizontalLine> getHorizontalLines(final Integer instrumentId) throws Exception;
	 ...
	 * @throws Exception HorizontalLine retrieval failed.
	 */
	HorizontalLine getHorizontalLine(final Integer id) throws Exception;
	 ...
	 */
	void updateHorizontalLine(final HorizontalLine horizontalLine) throws ObjectUnchangedException, Exception;
}
