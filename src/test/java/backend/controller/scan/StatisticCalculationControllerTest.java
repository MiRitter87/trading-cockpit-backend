...
public class StatisticCalculationControllerTest {
    ...
    private void createDummyIndicators() {
        ...
        try {
            ...
            this.appleQuotation1Indicator.setSma200((float) 75.34);
            ...
            this.appleQuotation2Indicator.setSma200((float) 76.01);
            ...
            this.microsoftQuotation2Indicator.setSma200((float) 250.60);
