...
public class MovingAverageCalculatorTest {
    ...
    public void testGetSimpleMovingAverage10Days() {
        ...
        float actualSma10, expectedSma10 = (float) 1.377;

        actualSma10 = this.movingAverageCalculator.getSimpleMovingAverage(10, sortedQuotations.getQuotations().get(0),
                sortedQuotations);
    ...
    public void testGetSimpleMovingAverage20Days() {
        QuotationArray sortedQuotations = new QuotationArray(this.dmlStock.getQuotationsSortedByDate());
        float actualSma20, expectedSma20 = (float) 1.349;

        actualSma20 = this.movingAverageCalculator.getSimpleMovingAverage(20, sortedQuotations.getQuotations().get(0),
                sortedQuotations);
    ...
    public void testGetSimpleMovingAverage50DaysHistorical() {
        ...
        actualSma50 = this.movingAverageCalculator.getSimpleMovingAverage(50, sortedQuotations.getQuotations().get(2),
                sortedQuotations);
    ...
    public void testGetSimpleMovingAverage150Days() {
        ...
        actualSma150 = this.movingAverageCalculator.getSimpleMovingAverage(150, sortedQuotations.getQuotations().get(0),
                sortedQuotations);
    ...
    public void testGetSimpleMovingAverage200Days() {
        ...
        actualSma200 = this.movingAverageCalculator.getSimpleMovingAverage(200, sortedQuotations.getQuotations().get(0),
                sortedQuotations);
    ...
    public void testGetExponentialMovingAverage21Days() {
        ...
        actualEma21 = this.movingAverageCalculator.getExponentialMovingAverage(21,
