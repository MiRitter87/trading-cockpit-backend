...
public class StochasticCalculatorTest {
	...
	public void testGetStochastic() {
		...
		actualStochastic = this.stochasticCalculator.getStochastic(14, sortedQuotations.getQuotations().get(0), sortedQuotations);
	...
	public void testGetSlowStochastic() {
		...
		actualSlowStochastic = this.stochasticCalculator.getSlowStochastic(14, sortedQuotations.getQuotations().get(0), sortedQuotations);
