	...
	public void testGetEodDataUsingCookie() {
		...
		try {
			try {
				...
				eodDataRequest.setAdditionalHeader("Accept", "*/*");
				eodDataRequest.setAdditionalHeader("Accept-Language", "de,en-US;q=0.7,en;q=0.3");
				eodDataRequest.setAdditionalHeader("Accept-Encoding", "gzip, deflate, br");
				...
				eodDataRequest.setAdditionalHeader("DNT", "1");
				...
				eodDataRequest.setAdditionalHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:123.0) Gecko/20100101 Firefox/123.0");
