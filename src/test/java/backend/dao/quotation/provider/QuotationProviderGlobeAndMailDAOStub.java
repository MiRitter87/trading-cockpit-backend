...
/**
 * Stub to simulate receiving of quotation data using the theglobeandmail.com website. A local HTML file is used instead
 * of a live query to theglobeandmail.com.
 *
 * @author Michael
 */
