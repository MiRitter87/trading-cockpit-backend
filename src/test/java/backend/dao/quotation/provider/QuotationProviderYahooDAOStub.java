...
/**
 * Stub to simulate receiving of quotation data using the finance API of Yahoo. A local JSON file is used instead of a
 * live query to Yahoo finance.
 *
 * @author Michael
 *
 */
public class QuotationProviderYahooDAOStub extends QuotationProviderYahooDAO {
     ...
     *
     * These files are currently not used because Yahoo has discontinued the quote API. Instead the chart API is used
     * now.
     *
